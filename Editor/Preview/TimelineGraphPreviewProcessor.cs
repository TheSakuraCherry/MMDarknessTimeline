...
namespace MMDarkness.Editor
{
    public class TimelineGraphPreviewProcessor
    {
        ...
        public TimelineGraphAsset TimelineGraphAsset { get; }
        ...
        public float Length
        {
            get
            {
                if (TimelineGraphAsset != null) return TimelineGraphAsset.Length;
        ...
        public void InitializePreviewPointers()
        {
            ...
            var timelineGraphProcessor = new TimelineGraphProcessor(TimelineGraphAsset.GetGraphModel());
            timelineGraphProcessor.Owner = Owner;

            for (var i = TimelineGraphAsset.groupAssets.Count - 1; i >= 0; i--)
            {
                ...
                for (var j = groupAsset.Tracks.Count - 1; j >= 0; j--)
                {
                    ...
                    for (var k = 0; k < trackAsset.Clips.Count; k++)
                    {
